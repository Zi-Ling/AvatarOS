...
type TabType = "documents" | "memories" | "skills";
...
export default function KnowledgePage() {
  ...
  const tabs = [
    { id: "documents" as TabType, label: t.knowledge.documents, icon: FileText, color: "text-blue-500" },
    { id: "memories" as TabType, label: t.knowledge.memories, icon: Database, color: "text-purple-500" },
    { id: "skills" as TabType, label: t.knowledge.skills, icon: Sparkles, color: "text-indigo-500" },
  ];
